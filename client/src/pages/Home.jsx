      ...
      <div className="flex-1 px-6 py-20">
        ...
        <div className="text-center mb-28">
          ...
          <motion.p
            ...
            Role-based mock interviews with smart follow-ups,adpative difficulty and real-time performance evaluation.
          </motion.p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-10">
            <motion.button
              ...
              className="bg-black text-white px-10 rounded-full hover:opacity-90 transition shadow-md">
              Start Interview
            </motion.button>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {
              [
                ...
                <motion.div key={index}
                  ...
                  className="bg-white border-gray-200 rounded-3xl shadow-sm hover:shadow-xl transition-all">
                  ...
                  className="bg-white border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all">
                    <div className="flex items-center justify-between gap-6">
                      ...
                      <h3 className="font-semibold text-xl mb-3">
                        ...
                        <p className="text-gray-500 text-sm leading-relaxed ">{mode.desc}            
                        </p>
                    </div>
