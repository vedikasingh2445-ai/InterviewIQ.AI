                    ...
                    <div className="flex items-center gap-6 relative">
                        ...
                        <div className="relative">
                            <button onClick={()=>{
                                ...
                                setShowCreditPopup(false)
                            }} className="w-9 h-9 bg-black text-white rounded-full items-center justify-center font-semibold">
                                {userData? userData?.name.slice(0,1).toUpperCase() : <FaUserAstronaut size={16}/> }
                            </button>

                            {showUserPopup && (
                                <div className="absolute right-0 mt-3 w-48 bg-white shadow-xl border-gray-300 rounded-xl p-4 z-50">
