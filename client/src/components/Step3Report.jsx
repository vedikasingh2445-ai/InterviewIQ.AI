...
function Step3Report({ report }) {
    ...
    const downloadPDF = () => {
        ...
        if(finalScore >= 8) {
            advice = 
            "Excellent performance. Maintain confidence and structure. Continue refining clarity and supporting answers wuth strong real-world examples.";
        }else if(finalScore >= 5){
            advice =
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                onClick={downloadPDF}
                 className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap">Download PDF</button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                <div className="space-y-6">
                    <motion.div
                        ...
                        <div className="mt-4">
                            <p className="font-semibold text-gray-800 text-sm sn:text-base">{performanceText}</p>
                        ...
                        <div className="space-y-5">
                            {
                                skills.map((s, i) => (
                                    <div key={i}>
                                        ...
                                        <div className="bg-gray h-2 sm:h-3 rounded-full">
                                ...
                                <div key={i} className="bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200">
                                    ...
                                    <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                                        ...
                                        <p className="text-sm text-gray-700 leading-relaxed">
                                            {q.feedback && q.feedback.trim() !== "" ? q.feedback : "No feedback for this question."}
                                        </p>
                                    </div>
                                </div>
                            ))}
