...
function Step2Interview({ interviewData, onFinish }) {
    ...
    }, [timeLeft, feedback, isSubmitting, currentQuestion, isIntroPhase]);
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-[1350px] min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden">
                {/* video section */}
